...
<div id="iaa-settings-sniper" style="display:block;">
  ...
  <input type="number" id="iaa-sniper-min-payout" min="60" max="92" step="1" value="70">
        ...
        <div class="iaa-field-row iaa-inline-newfilter" style="background:#fff7cc;border:1px solid #f6e7a7;border-radius:8px;padding:6px 8px;" title="НОВИ ФИЛТРИ (CS+EA+SE): Custom Supertrend, EMA Alignment, Stochastic Extreme. On: трите филтъра участват в точковата система. Off: не се прилагат.">
          <label class="iaa-checkbox iaa-new-setting" style="color:#7a5a00;font-weight:700;"><input type="checkbox" id="iaa-filter-trio-csea-enabled"> НОВИ ФИЛТРИ (CS + EA + SE)</label>
          <span class="iaa-field-label iaa-new-setting" style="color:#7a5a00;">on/off</span>
        </div>
